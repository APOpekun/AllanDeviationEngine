...
REM
REM Generated by Vivado on Thu Jul 02 18:07:11 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj TB_ReciprocalLUT_vlog.prj"
call xvlog  --incr --relax -L uvm -prj TB_ReciprocalLUT_vlog.prj -log xvlog.log
